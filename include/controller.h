...
/**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************//**
 * @brief Calls the dynamic function to change information to be sent or received through the serial port. 
 * 
 * @param[in,out] data The data coming from or to the serial port, to be managed by the module.
 * @param[in] dir Indication of the flow of information.
 * @param[in] controller The controller object that will be closed.
...
/**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************//**
 * @brief Calls the dynamic function to initialize the device connected to the serial port. 
 * 
 * @param[in] controller The controller object that will be closed.
 *
 * @return Upon success, the user should return 0. \n 
 ...
 * 
 **************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
int8_t mixlink_controller_driver_init(
  const enum direction dir,
  mixlink_controller_t * controller
);

/**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************//**
 * @brief Calls the dynamic function to close the device connected to the serial port. 
 * 
 * @param[in] controller The controller object that will be closed.
 *
 * @return Upon success, the user should return 0. \n 
 ...
 * 
 **************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
int8_t mixlink_controller_driver_deinit(
  const enum direction dir,
  mixlink_controller_t * controller
);

/**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************//**
 * @brief Calls the loop function of the serial port. 
 * 
 * @param[in] controller The controller object that will be closed.
 *
 * @return Upon success, the user should return 0. \n 
 ...
 * 
 **************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
int8_t mixlink_controller_driver_loop(
  const enum direction dir,
  mixlink_controller_t * controller
);
...
#define MIXLINK_CONTROLLER_MODULES \
  X(framer)                        \
  X(segm)                          \
  X(qos)                           

#define X(name) \
  MIXLINK_GEN_DEF_MODULES_DECL( controller, name, init  , mixlink_controller_t ) \
  MIXLINK_GEN_DEF_MODULES_DECL( controller, name, deinit, mixlink_controller_t ) \
  MIXLINK_GEN_DEF_MODULES_DECL( controller, name, loop  , mixlink_controller_t )
MIXLINK_CONTROLLER_MODULES
#undef X

#define X(name) \
  MIXLINK_GEN_IO_MODULES_DECL(controller, name, io, mixlink_controller_t)
X(framer)
X(qos)
#undef X
