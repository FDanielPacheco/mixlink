 ...
 * @date      01-10-2025
 *
 * @brief     A function designed to parse xml descriptors.  
 *  
...
/**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
const int8_t 
xml_get_value( const char * file_path, const char * key_tree, char * buf, size_t buf_len ){
  int8_t ret = -1;
  errno = 0;
  ...
  if( node && 0 < node->nodeNr ){
    ...
    if( content ){
      (void) strncpy( buf, (const char *) content, buf_len - 1);
